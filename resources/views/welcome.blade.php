...
<body>
    ...
    <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 flex items-center justify-center "
        style="float:right; margin-top: 150px; margin-right:100px;">
